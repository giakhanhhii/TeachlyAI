...
def main() -> None:
    ...
    render_table_png(
        OUT_DIR / "05-manual-checklist.png",
    ...
    render_table_png(
        OUT_DIR / "07-feedback-resolved.png",
    ...
    print("OK — wrote 7 PNGs to", OUT_DIR)
