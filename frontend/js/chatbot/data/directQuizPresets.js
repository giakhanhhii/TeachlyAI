...
function buildRelativeClausesBank() {
  const rows = [
    ...
    ["The year in _______ we graduated was unforgettable.", ["which", "where", "when", "whose"], 0, "Sau giới từ \"in\", dùng \"which\" để tạo cụm \"in which\"."],
    ...
    ["The woman to _______ we spoke at the conference is a robotics engineer.", ["who", "whom", "whose", "where"], 1, "Sau giới từ \"to\", dùng \"whom\" để chỉ người."],
    ...
    ["The day on _______ the final exam takes place is drawing near.", ["where", "when", "which", "whose"], 2, "Sau giới từ \"on\", dùng \"which\" để tạo cụm \"on which\"."],
    ...
    ["This is the moment at _______ the doors usually open.", ["that", "which", "when", "whose"], 1, "Sau giới từ \"at\", dùng \"which\" để tạo cụm \"at which\"."],
